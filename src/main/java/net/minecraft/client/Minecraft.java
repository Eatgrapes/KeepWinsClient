...
import static dev.eatgrapes.keepwins.KeepWins.*;
...
public class Minecraft implements IThreadListener {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(ClientName + ClientVersion + " | " + "Minecraft 1.8.9");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        // 使用自定义加载界面替换默认实现
        dev.eatgrapes.keepwins.ui.gui.loading.KeepWinsLoadingScreen.drawCustomBackground(scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight());
    ...
    public void dispatchKeypresses() {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent()) {
            // 分发
            if (dev.eatgrapes.keepwins.KeepWins.client != null && dev.eatgrapes.keepwins.KeepWins.client.getEventBus() != null) {
                dev.eatgrapes.keepwins.KeepWins.client.getEventBus().post(new dev.eatgrapes.keepwins.event.impl.KeyEvent(i));
            }
