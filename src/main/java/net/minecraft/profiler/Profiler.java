        ...
        if (this.profilerLocalEnabled) {
            if (this.profilingEnabled) {
                ...
                if (this.profilingMap.containsKey(this.profilingSection)) {
                    this.profilingMap.put(this.profilingSection, Long.valueOf(this.profilingMap.get(this.profilingSection) + k));
                } else {
    ...
    public List<Profiler.Result> getProfilingData(String profilerName) {
        if (!this.profilingEnabled) {
            ...
            for (String s3 : this.profilingMap.keySet()) {
                this.profilingMap.put(s3, Long.valueOf(this.profilingMap.get(s3) * 950L / 1000L));
            }
