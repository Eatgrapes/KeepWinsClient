...
import dev.eatgrapes.keepwins.event.api.EventData;
import dev.eatgrapes.keepwins.event.api.PseudoSubscriber;
import dev.eatgrapes.keepwins.event.api.SubscribeEvent;
import dev.eatgrapes.keepwins.event.type.EventPriority;
import dev.eatgrapes.keepwins.event.type.SubscriberDepth;
